...
class Ui_venPrincipal(object):
    def setupUi(self, venPrincipal):
        ...
        self.gridLayout.addWidget(self.lblDireccioncli, 3, 0, 1, 1, QtCore.Qt.AlignmentFlag.AlignRight)
        ...
        self.gridLayout.addWidget(self.lblProvinciacli, 1, 7, 1, 1, QtCore.Qt.AlignmentFlag.AlignRight)
        self.lblMunicipiocli = QtWidgets.QLabel(parent=self.pClientres)
        self.lblMunicipiocli.setObjectName("lblMunicipiocli")
        self.gridLayout.addWidget(self.lblMunicipiocli, 2, 7, 1, 1, QtCore.Qt.AlignmentFlag.AlignRight)
